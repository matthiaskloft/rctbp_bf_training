...
def launch_dashboard(
    ...
    ----------
    storage : str
        Database URL for the Optuna study (e.g., "sqlite:///optuna_study.db").
    ...
    From command line:
    >>> python -m rctbp_bf_training.core.optimization --dashboard sqlite:///study.db
    ...
    print(f"🚀 Starting Optuna Dashboard...")
...
def _cli_main():
    ...
    parser = argparse.ArgumentParser(
        description="Optuna optimization utilities for rctbp_bf_training",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  Launch dashboard:
    python -m rctbp_bf_training.core.optimization --dashboard sqlite:///study.db
    python -m rctbp_bf_training.core.optimization --dashboard sqlite:///study.db --port 8888
        """,
    )
    parser.add_argument(
        "--dashboard",
